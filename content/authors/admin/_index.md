...
Research：
1. **Chen,J.**(2020). Global wheat detection base one Confident learning.*European Conference on Computer Vision (ECCV) Workshop*(In delivering)
2. **Chen,J.**(2020). Image Recognition Technology Based on Neural Network.*IEEE Access*(In delivering)
